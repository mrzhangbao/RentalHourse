...
<body onload="getCur()">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="updateForm"  
							action="deleteAdmin" method="post">
							...
							<div class="form-group">
								<label for="id">管理员账号：</label><input class="form-control"
									type="text" name="account" id="account" disabled="true"  />
							</div>
							
							<div class="form-group">
								<label for="adminname">名称：</label><input class="form-control"
									type="text" name="adminname" id="adminname"  disabled="true" />
							</div>
							<div class="form-group">
							<label for="repassword">等级：</label>
								<select name="rank" id="rank" class="form-control" disabled="true">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-danger btn-lg"  onclick='commit()'>删除</button>
	...
	<script type="text/javascript">
		...
		function showModel(data) {
			...
			$('#account').val(data.admin.account);
